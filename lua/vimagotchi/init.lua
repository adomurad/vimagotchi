...
local function create_user_commands()
  vim.api.nvim_create_user_command('Vimagotchi', function(args)
    if args.args == '' then
      print 'Error: MyCmd requires an argument (a, b, or c)'
      return
    end

    if args.args == 'Open' then
      M.toggle_chat()
    elseif args.args == 'ChatNew' then
      M.new_chat()
    elseif args.args == 'PasteIntoChat' then
      M.paste_into_chat()
    elseif args.args == 'PasteIntoNewChat' then
      M.paste_into_new_chat()
    elseif args.args == 'ChatSend' then
      M.send_chat()
    elseif args.args == 'ChatFind' then
      M.find_chat()
    elseif args.args == 'InlineAdd' then
      M.inline_add()
    elseif args.args == 'InlineEdit' then
      M.inline_edit()
    else
